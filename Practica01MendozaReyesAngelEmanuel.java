...
public class Practica01MendozaReyesAngelEmanuel extends JPanel {
    public Practica01MendozaReyesAngelEmanuel() {
    ...
    public static void main(String[] args) {
        ...
        frame.add(new Practica01MendozaReyesAngelEmanuel());
